  ...
  return (
    <div className="flex flex-col mx-5 xl:mx-32 md:mx-10 mt-5 flex-grow">
     <div >
      ...
      <img src="../src/assets/poster1.jpg" alt="" className='rounded object-fill aspect-16:9'/> 
      ...
      <div className="mx-2">
          <h2 className="text-md md:text-xl font-bold mt-3 text-primary-800">{event.ticketPrice === 0? 'Free' : 'LKR. '+ event.ticketPrice}</h2>
      </div>
      <div className="mx-2 mt-5 text-md md:text-lg truncate-3-lines">
        {event.description}
      </div>
      <div className="mx-2 mt-5 text-md md:text-xl font-bold text-primary-800">
      ...
      <div className="mx-2 mt-5">
        ...
        <div className="sm:mx-5 lg:mx-32 mt-6 flex flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            <AiFillCalendar className="w-auto h-5 text-primary-800 "/>
          ...
          <div className="">
            <div className="flex items-center gap-4">
            <MdLocationPin className="w-auto h-5 text-primary-800 "/>
            <div className="flex flex-col gap-1">
