...
//! Search input ----------------------------------------------------------------
  ...
  return (
    <div>
      <header className="flex py-2 px-4 sm:px-6 justify-between items-center shadow-md shadow-gray-200">
    
          <Link to={'/'} className="flex item-center ">
            {/* <img src="../src/assets/logo.png" alt="" className='w-27 h-12'/> */}
            <img src="../src/assets/logo.png" alt="" className="h-16 w-auto" />
          ...
          {/* ---- ROLE BASED BUTTON (ADMIN → CREATE EVENT | VISITOR → BOOK TICKET) ---- */}
          {user?.role === "admin" && (
            <Link to={'/createEvent'}>
              <div className='hidden md:flex flex-col place-items-center py-1 px-2 rounded text-primary cursor-pointer hover:text-primary-800 hover:bg-white hover:shadow-sm shadow-gray-200 hover:transition-shadow duration-1500'>
          ...
          {user?.role === "user" && (
            ...
            <div className='flex flex-col place-items-center py-1 px-3 rounded cursor-pointer hover:text-primary-800 hover:bg-white hover:shadow-sm shadow-gray-200 hover:transition-shadow duration-1500'>
