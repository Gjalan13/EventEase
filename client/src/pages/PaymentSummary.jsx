...
//! creating a ticket ------------------------------
    const createTicket = async (e) => {
      ...
      try {
        ...
        // 3. Payload MUST match backend schema
        const payload = {
          userid: updatedTicketDetails.userid,
          eventid: updatedTicketDetails.eventid,

          ticketDetails: {
            name: updatedTicketDetails.ticketDetails.name,
            email: updatedTicketDetails.ticketDetails.email,
            eventname: updatedTicketDetails.ticketDetails.eventname,
            eventdate: updatedTicketDetails.ticketDetails.eventdate,
            eventtime: updatedTicketDetails.ticketDetails.eventtime,
            ticketprice: updatedTicketDetails.ticketDetails.ticketprice,
            qr: updatedTicketDetails.ticketDetails.qr,
          },

          count: updatedTicketDetails.count || 1
        };
