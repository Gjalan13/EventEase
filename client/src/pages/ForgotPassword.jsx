    ...
    <div className ="flex w-full h-full px-10 py-10 justify-center place-items-center mt-20">
      <div className= "bg-white w-1/3 px-7 py-7 rounded-xl">
        ...
        <form className="flex flex-col w-auto items-center" onSubmit=''>
            <h1 className='px-3 font-extrabold mb-5 text-primary-800 text-2xl '>Forgot Password</h1>
            ...
            <Link to={'/login'} className="flex gap-2 items-center text-primary py-2 px-4 bg-primary-100 cursor-pointer ring-1 ring-primary-100 rounded  hover:bg-primary-800 hover:shadow-lg duration-75 hover:ring-primary-800 hover:text-white">
